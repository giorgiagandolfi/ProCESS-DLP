...
set.seed(12345)
setwd("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/dlp_simulation_6/")
sim <- TissueSimulation(name = "DLP",save_snapshots = T)
...
forest$save("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/dlp_simulation_6/sample_forest_6.sff")
...
m_engine$add_mutant(mutant_name = "B",passenger_rates = c(SNV = mu_SNV, CNA = 0,indel=mu_INDELs),
                    drivers = list(CNA_Clone2))
m_engine$add_mutant(mutant_name = "C",passenger_rates = c(SNV = mu_SNV, CNA = 0,indel=mu_INDELs),drivers = list("KRAS G12D",CNA_Clone3))
...
phylo_forest$save("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/dlp_simulation_6/phylo_forest_6.sff")
