...
cell_idx <- as.numeric(args[1])+4000
print(cell_idx)
...
dir.create(path = paste0("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/SCOUT/SPN01/process/sequencing_",cell_name))
...
results <- parallel::mclapply(
  ...
  function(chr) {
    simulate_seq(
      ...
      wide_format=FALSE,
      output_dir = paste0("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/SCOUT/SPN01/process/sequencing_",cell_name),
      update_SAM = TRUE
    )
  },
  mc.cores = 4
...
saveRDS(object = results,file = paste0("/orfeo/cephfs/scratch/cdslab/ggandolfi/Github/ProCESS-DLP/SCOUT/SPN01/process/sequencing_",cell_name,"/seq_res.rds"))
